...
const GridRowProductCard = ({
	...
	return (
		<Link
			className="relative bg-white rounded-lg border shadow-md max-w-xs md:max-w-none overflow-hidden group flex"
			onMouseEnter={() => setIsHovered(true)}
			onMouseLeave={() => setIsHovered(false)}
		>
			<div className="relative overflow-hidden cursor-pointer w-[25%]">
				<img
			...
			<div className="pt-6 pb-8 px-5 w-[75%]">
				...
				<p className="text-sm line-clamp-2 text-gray-400 font-rregular mt-2">
					{description}
				</p>
...
export default GridRowProductCard;
